      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              ...
              <ul class="nav navbar-right panel_toolbox">
                <li class="list"><a data-toggle="tooltip" data-placement="left" title="Listar" class="collapse-link" title="Listar" href="{{url('porteiros')}}"><i class="fa fa-list"></i> porteiros</a></li>
              </li>
            </ul>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            ...
            <p>Para listar os porteiros cadastrados, clique no botão na barra acima</p>
            ...
            @if(Request::is('*/editar'))
              {{-- editando PUT --}}
              {!! Form::model($porteiro, ['url' => 'porteiro/'.$porteiro->id.'/editar','class' => 'form-horizontal form-label-left', 'method' => 'PUT']) !!}
            @else
              {{-- incluindo POST --}}
              {!! Form::open(['url' => 'porteiro/novo', 'class' => 'form-horizontal form-label-left']) !!}
            @endif
