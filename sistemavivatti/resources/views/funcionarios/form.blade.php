          ...
          <div class="x_panel">
            <div class="x_title">
              ...
              <ul class="nav navbar-right panel_toolbox">
                <li class="list"><a href="{{url('prestadores')}}"class="collapse-link" title="Voltar" ><i class="fa fa-reply-all"></i> Prestadores</a></li>
                <li class="divider"></li>
                <li class="list">
                  <a href="{{ url('prestador/'.$prestador->id.'/funcionarios') }}" data-toggle="tooltip" data-placement="left" title="Listar" class="collapse-link" title="Listar" >
                    <i class="fa fa-list"></i> Funcionarios
                  </a>
                </li>
              </ul>
              <div class="clearfix"></div>
            ...
            <div class="x_content">
              ...
              <p>Para listar os funcionários cadastrados de <b>{{$prestador->nome}}</b>, clique no botão na barra acima</p>
              ...
              @if(Request::is('*/editar'))
                {{-- editando PUT --}}
                {!! Form::model($funcionario, ['url' => 'prestador/'.$prestador->id.'/funcionario/'.$funcionario->id.'/editar','class' => 'form-horizontal form-label-left', 'method' => 'PUT']) !!}
              @else
                {{-- incluindo POST --}}
                {!! Form::open(['url' => 'prestador/'.$prestador->id.'/funcionario/novo', 'class' => 'form-horizontal form-label-left']) !!}
              @endif
