! function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.VueStrap = e() : t.VueStrap = e()
}(this, function() {
    return function(t) {
        function e(i) {
        ...
        var o = n(25),
            ...
            Q = {
                ...
                affix: f["default"],
                aside: v["default"],
                checkboxBtn: x["default"],
                checkboxGroup: y["default"],
        ...
        function c(t, e) {
            ...
            if (e.singleton) {
                var r = g++;
                n = y || (y = a(e)), i = u.bind(null, n, r, !1), o = u.bind(null, n, r, !0)
            ...
            }) : (n = a(e), i = d.bind(null, n), o = function() {
                s(n)
            });
            return i(t),
                function(e) {
        ...
        e["default"] = {
            ...
            methods: {
                slide: function(t, e, n) {
                    ...
                    "left" === t ? s.classList.add("next") : s.classList.add("prev");
                    s.clientHeight;
                    this._prevSelectedEvent = a["default"].listen(o, "transitionend", l), this._selectedEvent = a["default"].listen(s, "transitionend", l), o.classList.add(t), s.classList.add(t)
                },
                nextClick: function() {
        ...
        t.exports = function(t) {
            return function(e, n) {
                var r, s, a = String(o(e)),
                    l = i(n),
                    c = a.length;
                return 0 > l || l >= c ? t ? "" : void 0 : (r = a.charCodeAt(l), 55296 > r || r > 56319 || l + 1 === c || (s = a.charCodeAt(l + 1)) < 56320 || s > 57343 ? t ? a.charAt(l) : r : t ? a.slice(l, l + 2) : (r - 55296 << 10) + (s - 56320) + 65536)
            }
        }
    }, function(t, e) {
        var n = Math.ceil,
        ...
        t.exports = function(t, e, n, g, x, b, w) {
            ...
            var k, _, M, D = function(t) {
                ...
                A = "Array" == e ? R.entries || j : j;
            if (A && (M = d(A.call(new t)), M !== Object.prototype && (u(M, S, !0), i || a(M, p) || s(M, p, y))), O && j && j.name !== m && (E = !0, C = function() {
                    return j.call(this)
                }), i && !w || !f && !E && R[p] || s(R, p, C), l[e] = C, l[S] = y, x)
                if (k = {
                        values: O ? C : D(m),
                        keys: b ? C : D(v),
                        entries: $
                    }, w)
                    for (_ in k) _ in R || r(R, _, k[_]);
                else o(o.P + o.F * (f || E), e, k);
            return k
        }
    }, function(t, e) {
        t.exports = !0
        ...
        var i = n(47),
            ...
            l = function(t, e, n) {
                var c, u, d, p = t & l.F,
                    ...
                    b = f ? i : h ? i[e] : (i[e] || {})[a];
                f && (n = e);
                for (c in n) u = !p && b && void 0 !== b[c], u && c in g || (d = u ? b[c] : n[c], g[c] = f && "function" != typeof b[c] ? n[c] : m && u ? r(d, i) : y && b[c] == d ? function(t) {
        ...
        e.f = n(56) ? Object.defineProperty : function(t, e, n) {
        ...
        var i = n(53),
            ...
            c = function() {
                var t, e = n(58)("iframe"),
                    i = r.length,
                    o = ">";
                for (e.style.display = "none", n(79).appendChild(e), e.src = "javascript:", t = e.contentWindow.document, t.open(), t.write("<script>document.F=Object</script" + o), t.close(), c = t.F; i--;) delete c[l][r[i]];
                return c()
            };
        t.exports = Object.create || function(t, e) {
            var n;
            return null !== t ? (a[l] = i(t), n = new a, a[l] = null, n[s] = t) : n = c(), void 0 === e ? n : o(n, e)
        }
    }, function(t, e, n) {
        var i = n(52),
            o = n(53),
            r = n(67);
        t.exports = n(56) ? Object.defineProperties : function(t, e) {
            o(t);
        ...
        o(o.S + o.F * !n(90)(function(t) {
            ...
            from: function(t) {
                var e, n, o, d, p = r(t),
                    ...
                    y = 0,
                    g = u(p);
                if (m && (v = i(v, h > 2 ? arguments[2] : void 0, 2)), void 0 == g || f == Array && a(g))
                    for (e = l(p.length), n = new f(e); e > y; y++) c(n, y, m ? v(p[y], y) : p[y]);
                else
                    for (d = g.call(p), n = new f; !(o = d.next()).done; y++) c(n, y, m ? s(d, v, [o.value, y], !0) : o.value);
                return n.length = y, n
            }
        })
    }, function(t, e, n) {
        ...
        e["default"] = {
            ...
            methods: {
                ...
                getScroll: function(t, e) {
                    ...
                    if ("number" != typeof n) {
                        var o = t.document;
                        n = o.documentElement[i], "number" != typeof n && (n = o.body[i])
                    }
                    return n
                },
        ...
        e["default"] = {
            ...
            watch: {
                show: function(t) {
                    ...
                    var i = (0, a["default"])();
                    if (t) {
                        n.appendChild(e), n.classList.add("modal-open"), 0 !== i && (n.style.paddingRight = i + "px");
                        e.clientHeight;
                        e.className += " in", this._clickEvent = r["default"].listen(e, "click", this.close)
                    } else {
        ...
        e["default"] = {
            ...
            methods: {
                ...
                stringify: function(t) {
                    var e = arguments.length <= 1 || void 0 === arguments[1] ? this.format : arguments[1],
                        ...
                        o = t.getDate(),
                        r = this.parseMonth(t);
                    return e.replace(/yyyy/g, n).replace(/MMMM/g, r).replace(/MMM/g, r.substring(0, 3)).replace(/MM/g, ("0" + i).slice(-2)).replace(/dd/g, ("0" + o).slice(-2)).replace(/yy/g, n).replace(/M(?!a)/g, i).replace(/d/g, o)
                },
                parse: function(t) {
                    10 != t.length || "dd-MM-yyyy" != this.format && "dd/MM/yyyy" != this.format || (t = t.substring(3, 5) + "-" + t.substring(0, 2) + "-" + t.substring(6, 10));
                    var e = new Date(t);
                ...
                getDateRange: function() {
                    ...
                    for (var e = {
                        ...
                        }, n = e.year.toString(), i = n.substring(0, n.length - 1) + 0 - 1, o = 0; 12 > o; o++) this.decadeRange.push({
                        text: i + o
                    });
                    ...
                    if (s > 1)
                        for (var l = this.getYearMonth(e.year, e.month - 1), c = this.getDayCount(l.year, l.month), o = 1; s > o; o++) {
                            var u = c - s + o + 1;
                            this.dateRange.push({
                                text: u,
                    ...
                    for (var d = function(n) {
                            ...
                            if (t.disabledDaysOfWeek.forEach(function(t) {
                                ...
                                s && s.getFullYear() === e.year && s.getMonth() === e.month && (r = "datepicker-dateRange-item-active")
                            }
                            t.dateRange.push({
                                text: n,
                                date: i,
                    ...
                    if (this.dateRange.length < 42)
                        for (var p = 42 - this.dateRange.length, f = this.getYearMonth(e.year, e.month + 1), o = 1; p >= o; o++) this.dateRange.push({
                            text: o,
                            date: new Date(f.year, f.month, o),
                            sclass: "datepicker-item-gray"
                        })
                }
            },
            ready: function() {
                var t = this;
                this.$dispatch("child-created", this), this.currDate = this.parse(this.value) || this.parse(new Date), this._closeEvent = r["default"].listen(window, "click", function(e) {
        ...
        e["default"] = {
            ...
            ready: function() {
                ...
                e && (e.style.borderRadius = "4px", e.addEventListener("click", this.toggleDropdown)), this._closeEvent = r["default"].listen(window, "click", function(e) {
        ...
        var o = n(91),
            ...
            l = {
                ...
                ready: function() {
                    ...
                    switch ("hover" === this.trigger ? (this._mouseenterEvent = r["default"].listen(n, "mouseenter", function() {
                        return t.show = !0
                        ...
                        return t.show = !1
                    })) : this._clickEvent = r["default"].listen(n, "click", this.toggle), this.placement) {
                        case "top":
        ...
        e["default"] = {
                    ...
                    if (this.value.length) {
                        ...
                        try {
                            for (var o, s = (0, r["default"])(this.value); !(e = (o = s.next()).done); e = !0) {
                                var a = o.value;
                                if (0 === this.options.length) t = this.value;
                                else if ("string" == typeof a) {
                                    var l = void 0;
                                    this.options.some(function(t) {
            ...
            watch: {
                value: function(t) {
                    var e = this;
                    t.length > this.limit && (this.showNotify = !0, this.value.pop(), setTimeout(function() {
        ...
        n(167);
        for (var i = n(47), o = n(51), r = n(63), s = n(81)("toStringTag"), a = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], l = 0; 5 > l; l++) {
            var c = a[l],
                u = i[c],
                d = u && u.prototype;
        ...
        var i = n(53),
            o = n(88);
        t.exports = n(48).getIterator = function(t) {
            var e = o(t);
        ...
        var o = n(191),
            ...
            l = {
                ...
                computed: {
                    primitiveData: function() {
                        ...
                        return this.data ? this.data.filter(function(e) {
                            e = t.matchCase ? e : e.toLowerCase();
                            var n = t.matchCase ? t.query : t.query.toLowerCase();
                            return t.matchStart ? 0 === e.indexOf(n) : -1 !== e.indexOf(n)
                ...
                methods: {
                    update: function() {
                        var t = this;
                        return this.query ? (this.data && (this.items = this.primitiveData, this.showDropdown = this.items.length ? !0 : !1), void(this.async && (0, r["default"])(this.async + this.query, function(e) {
                            t.items = e[t.key].slice(0, t.limit), t.showDropdown = t.items.length ? !0 : !1
                        }))) : (this.reset(), !1)
                    },
                    reset: function() {
        ...
        e["default"] = {
            methods: {
                toggleCollapse: function(t) {
                    t.preventDefault();
                    var e = this.$el.querySelector("[data-target]"),
                        n = e.getAttribute("data-target"),
                        i = document.getElementById(n.substring(1));
                    i.classList.toggle("collapse")
                }
            },
            ready: function() {
                var t = this,
                    e = this.$el.querySelector('[data-toggle="collapse"]');
                e && (e.style.borderRadius = "4px", e.addEventListener("click", this.toggleCollapse)), this._closeEvent = r["default"].listen(window, "click", function(e) {
        ...
        e["default"] = {
            ...
            events: {
                "show::spinner": function(t) {
                    this.show(t)
                },
                "hide::spinner": function() {
                    this.hide()
                },
                "start::ajax": function(t) {
                    this.show(t)
                },
                "end::ajax": function() {
                    this.hide()
